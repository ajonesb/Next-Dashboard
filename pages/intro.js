...
import introData from "./api/intro/introData";
import data1 from "./api/intro/data1";
        ...
        <div className={styles.content_container}>
          ...
          <div className={styles.charts_container}>
            <div className={styles.bar_graph_wrapper}>
              <h2 className={styles.bar_graph_title}>Sales</h2>
              <Line data={introData} width={400} height={400} />
            </div>
            <div className={styles.circle_graph_wrapper}>
              <h2 className={styles.circle_graph_title}>Customers Arrived</h2>
